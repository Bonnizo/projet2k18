...
//		eff.addActionListener(new boutoneffacer());
	...
	private void victoire() {
		...
		if(choix==1) {
		JOptionPane.showMessageDialog(null, "Le gagnant est : " + name1, "Victoire !", JOptionPane.INFORMATION_MESSAGE);
		effacergame();
		}
		else if(choix==2) {
		JOptionPane.showMessageDialog(null, "Le gagnant est : " + name2, "Victoire !", JOptionPane.INFORMATION_MESSAGE);
		effacergame();
		}
		
		if(cptclick==9) {
		JOptionPane.showMessageDialog(null, "Il n'y a pas de gagnant !", "Match null", JOptionPane.INFORMATION_MESSAGE);
		effacergame();
		}
